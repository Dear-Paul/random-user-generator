const UserCard = ({user, showCountry, showDetails}) => {
    ...
    return (
        <div className="relative mb-6 p-4 md:h-[150px] w-[100%] bg-white mt-4 shadow-lg  rounded-[15px] shadow-gray-500">
            <div className="absolute w-[95%] h-[80%] md:flex flex-row justify-evenly">
                <div className="h-[100px] w-[100px] relative rounded-[50%] bg-slate-400 border-[6px] border-teal-300">
